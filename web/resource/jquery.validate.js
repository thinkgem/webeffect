 ...
 *
 * $Id: jquery.validate.js 2351 2010-05-16 10:16:58Z wzhen $
 *
...
$.extend($.validator, {
	...
	methods: {
		...
		email: function(value, element) {
			...
			return this.optional(element) || /(^[a-zA-Z0-9]|^[a-zA-Z0-9][\w-_\.]*[a-zA-Z0-9])@(\w+\.)+\w+$/.test(value);
		},
...
jQuery.validator.addMethod("username",function(value, element) {
	return this.optional(element) || /^[a-zA-Z0-9][a-zA-Z0-9_]{3,19}$/.test(value);
},"4-20位字母或数字开头，允许字母数字下划线");
...
jQuery.validator.addMethod("idCard",function(value, element) {
	return this.optional(element) || /^[1-9]([0-9]{14}|[0-9]{17}|[0-9]{16}[Xx])?$/.test(value);
},"请输入正确的身份证号码(15-18位)")
*/
//真实姓名验证
